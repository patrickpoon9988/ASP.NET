...
{
    public static WebApplication1.Controllers.AccountController Account = new WebApplication1.Controllers.T4MVC_AccountController();
    public static WebApplication1.Controllers.HomeController Home = new WebApplication1.Controllers.T4MVC_HomeController();
    public static WebApplication1.Controllers.LoginController Login = new WebApplication1.Controllers.T4MVC_LoginController();
    public static WebApplication1.Controllers.MoreController More = new WebApplication1.Controllers.T4MVC_MoreController();
    public static T4MVC.DefaultController Default = new T4MVC.DefaultController();
    public static T4MVC.RolesController Roles = new T4MVC.RolesController();
